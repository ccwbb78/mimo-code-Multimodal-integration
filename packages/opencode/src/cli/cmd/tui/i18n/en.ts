export const dict: Record<string, string> = {
  ...
  // Multimodal bridge
  "tui.command.multimodal_bridge.title": "Multimodal Bridge",
  "tui.command.multimodal_bridge.title_on": "Multimodal Bridge: ON — click to turn off",
  "tui.command.multimodal_bridge.title_off": "Multimodal Bridge: OFF — click to turn on",
  "tui.multimodal_bridge.enabled": "Multimodal bridge enabled — images will be analyzed by mimo-v2.5 vision model before reasoning",
  "tui.multimodal_bridge.disabled": "Multimodal bridge disabled",

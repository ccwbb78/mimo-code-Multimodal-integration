...
export const dict = {
  ...
  // Multimodal bridge
  "tui.command.multimodal_bridge.title": "マルチモーダルブリッジ",
  "tui.command.multimodal_bridge.title_on": "マルチモーダルブリッジ：ON — クリックでOFF",
  "tui.command.multimodal_bridge.title_off": "マルチモーダルブリッジ：OFF — クリックでON",
  "tui.multimodal_bridge.enabled": "マルチモーダルブリッジ有効 — 画像はmimo-v2.5ビジョンモデルで分析されてから推論モデルに渡されます",
  "tui.multimodal_bridge.disabled": "マルチモーダルブリッジ無効",

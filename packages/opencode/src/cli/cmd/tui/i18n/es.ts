...
export const dict = {
  ...
  // Multimodal bridge
  "tui.command.multimodal_bridge.title": "Puente multimodal",
  "tui.command.multimodal_bridge.title_on": "Puente multimodal: ACTIVADO — clic para desactivar",
  "tui.command.multimodal_bridge.title_off": "Puente multimodal: DESACTIVADO — clic para activar",
  "tui.multimodal_bridge.enabled": "Puente multimodal activado — las imágenes serán analizadas por el modelo de visión mimo-v2.5 antes del razonamiento",
  "tui.multimodal_bridge.disabled": "Puente multimodal desactivado",

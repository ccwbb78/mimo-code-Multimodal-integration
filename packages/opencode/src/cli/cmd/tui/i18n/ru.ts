...
export const dict = {
  ...
  // Multimodal bridge
  "tui.command.multimodal_bridge.title": "Мультимодальный мост",
  "tui.command.multimodal_bridge.title_on": "Мультимодальный мост: ВКЛ — нажмите для выключения",
  "tui.command.multimodal_bridge.title_off": "Мультимодальный мост: ВЫКЛ — нажмите для включения",
  "tui.multimodal_bridge.enabled": "Мультимодальный мост включён — изображения будут проанализированы моделью mimo-v2.5 перед передачей в модель рассуждений",
  "tui.multimodal_bridge.disabled": "Мультимодальный мост отключён",

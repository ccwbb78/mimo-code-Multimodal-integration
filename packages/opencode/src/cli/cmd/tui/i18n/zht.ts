...
export const dict = {
  ...
  // Multimodal bridge
  "tui.command.multimodal_bridge.title": "多模態橋接",
  "tui.command.multimodal_bridge.title_on": "多模態橋接：已開啟 — 點擊關閉",
  "tui.command.multimodal_bridge.title_off": "多模態橋接：已關閉 — 點擊開啟",
  "tui.multimodal_bridge.enabled": "多模態橋接已啟用 — 圖片將透過 mimo-v2.5 視覺模型分析後傳遞給推理模型",
  "tui.multimodal_bridge.disabled": "多模態橋接已關閉",

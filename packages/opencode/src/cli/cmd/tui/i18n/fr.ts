...
export const dict = {
  ...
  // Multimodal bridge
  "tui.command.multimodal_bridge.title": "Pont multimodal",
  "tui.command.multimodal_bridge.title_on": "Pont multimodal : ACTIVÉ — cliquer pour désactiver",
  "tui.command.multimodal_bridge.title_off": "Pont multimodal : DÉSACTIVÉ — cliquer pour activer",
  "tui.multimodal_bridge.enabled": "Pont multimodal activé — les images seront analysées par le modèle de vision mimo-v2.5 avant le raisonnement",
  "tui.multimodal_bridge.disabled": "Pont multimodal désactivé",

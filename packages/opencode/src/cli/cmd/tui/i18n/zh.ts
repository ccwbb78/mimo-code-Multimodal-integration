...
export const dict = {
  ...
  // Multimodal bridge
  "tui.command.multimodal_bridge.title": "多模态整合",
  "tui.command.multimodal_bridge.title_on": "多模态整合：已开启 — 点击关闭",
  "tui.command.multimodal_bridge.title_off": "多模态整合：已关闭 — 点击开启",
  "tui.multimodal_bridge.enabled": "多模态整合已启用 — 图片将通过 mimo-v2.5 视觉模型分析后传递给推理模型",
  "tui.multimodal_bridge.disabled": "多模态整合已关闭",

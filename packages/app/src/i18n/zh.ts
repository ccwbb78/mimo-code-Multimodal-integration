...
export const dict = {
  ...
  "command.help.show": "显示帮助",
  "command.help.show.description": "打开帮助对话框",
  "command.docs.open": "打开文档",
  "command.docs.open.description": "在浏览器中打开 MiMoCode 文档",
  "command.app.toggle.animations": "切换动画",
  "command.app.toggle.animations.description": "启用或禁用 UI 动画效果",
  "command.session.export": "导出会话",
  "command.session.export.description": "将会话记录导出到文件",
  "command.session.copy": "复制会话",
  "command.session.copy.description": "将会话记录复制到剪贴板",
  ...
  "dialog.provider.opencode.note": "使用 MiMoCode Zen 或 API 密钥连接",
  ...
  "provider.connect.opencodeZen.line1": "MiMoCode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.opencodeZen.visit.link": "mimo.xiaomi.com/zen",
  ...
  "settings.general.row.showFileTree.description": "在桌面端会话中显示文件树切换和面板",
  ...
  "onboarding.ask.title": "欢迎使用 MiMoCode",
  "onboarding.ask.description": "你是 Vibe Coding 老手吗？如果不是，我们将为你提供一个快速上手引导。",
  "onboarding.ask.no": "不是，我需要引导",
  "onboarding.ask.yes": "是，我已了解",
  "onboarding.guide.title": "快速上手",
  "onboarding.guide.skip": "跳过",
  "onboarding.guide.prev": "上一步",
  "onboarding.guide.next": "下一步",
  "onboarding.guide.finish": "完成",
  "onboarding.step1.title": "打开项目",
  "onboarding.step1.description": "点击左侧「打开项目」按钮，选择你的本地代码目录开始使用。",
  "onboarding.step2.title": "开始对话",
  "onboarding.step2.description": "在底部输入框中输入你的问题或需求，AI 将为你编写代码。",
  "onboarding.step3.title": "查看变更",
  "onboarding.step3.description": "AI 修改代码后，可以在「审查」面板中查看所有文件变更。",
  "onboarding.step4.title": "使用终端",
  "onboarding.step4.description": "点击顶部终端按钮打开内置终端，运行构建、测试等命令。",
  "onboarding.step5.title": "个性化设置",
  "onboarding.step5.description": "点击左下角设置图标，自定义主题、语言、快捷键等偏好。",

export const dict = {
  ...
  "command.help.show": "Show help",
  "command.help.show.description": "Open help dialog",
  "command.docs.open": "Open documentation",
  "command.docs.open.description": "Open MiMoCode documentation in browser",
  "command.app.toggle.animations": "Toggle animations",
  "command.app.toggle.animations.description": "Enable or disable UI animations",
  "command.session.export": "Export session",
  "command.session.export.description": "Export session transcript to file",
  "command.session.copy": "Copy session",
  "command.session.copy.description": "Copy session transcript to clipboard",
  ...
  "onboarding.ask.title": "Welcome to MiMoCode",
  "onboarding.ask.description": "Are you experienced with Vibe Coding? If not, we'll provide a quick start guide for you.",
  "onboarding.ask.no": "No, I need guidance",
  "onboarding.ask.yes": "Yes, I'm familiar",
  "onboarding.guide.title": "Quick Start",
  "onboarding.guide.skip": "Skip",
  "onboarding.guide.prev": "Previous",
  "onboarding.guide.next": "Next",
  "onboarding.guide.finish": "Finish",
  "onboarding.step1.title": "Open Project",
  "onboarding.step1.description": "Click the 'Open Project' button on the left to select your local code directory and get started.",
  "onboarding.step2.title": "Start Conversation",
  "onboarding.step2.description": "Type your question or request in the input box at the bottom, and AI will write code for you.",
  "onboarding.step3.title": "Review Changes",
  "onboarding.step3.description": "After AI modifies code, you can review all file changes in the 'Review' panel.",
  "onboarding.step4.title": "Use Terminal",
  "onboarding.step4.description": "Click the terminal button at the top to open the built-in terminal and run build, test, and other commands.",
  "onboarding.step5.title": "Personalize Settings",
  "onboarding.step5.description": "Click the settings icon in the bottom left to customize theme, language, shortcuts, and other preferences.",
